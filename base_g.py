...
test_data_gen = val_generator.flow_from_dataframe(dataframe=label_test, #ADD THIS GENERATOR
                                                              batch_size=1,
                                                              x_col='id',
                                                              y_col='breed',
...
model.save("model_g_final.h5") #ADDED
print("Saved model to disk")
'''
loaded_model = load_model("model_g_final.h5") #ADDED
